...
export default function (customConfig) {
	...
	this.print = function () {
		...
		if (data.touchDevice != undefined)
			html.dataset.touchdevice = data.touchDevice;
		...
		function updateScroll() {
			...
			if (data.scrollDirection != undefined)
				html.dataset.scrolldirection = data.scrollDirection;
			if (data.scrollPosition != undefined)
				html.dataset.scrollposition = data.scrollPosition;
			if (data.scrollPercentage != undefined)
				html.dataset.scrollpercentage = data.scrollPercentage;
		}
	};
}
